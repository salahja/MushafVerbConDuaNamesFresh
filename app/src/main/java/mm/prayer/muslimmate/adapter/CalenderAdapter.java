...
public class CalenderAdapter extends ArrayAdapter<CalendarCell> {
    ...
    public CalenderAdapter(Context context) {
        super(context, R.layout.mm_calender_cell);
        this.context = context;

        //events array list
        eventList = new ArrayList<AppEvent>();
        eventList.add(new AppEvent(context.getString(R.string.ramdanstart), "1-9-1437"));
        eventList.add(new AppEvent(context.getString(R.string.laylt_kader), "27-9-1437"));
        eventList.add(new AppEvent(context.getString(R.string.eid_el_feter), "1-10-1437"));
        eventList.add(new AppEvent(context.getString(R.string.wafet_el_arafa), "9-12-1437"));
        eventList.add(new AppEvent(context.getString(R.string.el_adha), "10-12-1437"));
        eventList.add(new AppEvent(context.getString(R.string.islamic_year), "1-1-1438"));
        eventList.add(new AppEvent(context.getString(R.string.milad_al_naby), "1-3-1438"));
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.mm_calender_cell, null);
