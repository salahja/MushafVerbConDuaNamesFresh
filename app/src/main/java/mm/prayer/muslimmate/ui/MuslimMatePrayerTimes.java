 ...
 * @author Usama
 */
public class MuslimMatePrayerTimes {
    ...
    public MuslimMatePrayerTimes(int day, int month, int year, double latitude, double longitude, double timeZone, boolean dayLightSaving, Mazhab mazhab, Way way) {
