...
public class ConfigPreferences {
     ...
     *
     * @param weatherApp Weather list
     */
    public static void setWeather(Context context, List<WeatherApp> weatherApp) {
        SharedPreferences.Editor editor = context.getSharedPreferences
                (MAIN_CONFIG, Context.MODE_PRIVATE).edit();
        Gson gson = new Gson();
     ...
     *
     * @param weatherApp Weather list of week
     */
    public static void setWeekListWeather(Context context, List<WeatherApp> weatherApp) {
        SharedPreferences.Editor editor = context.getSharedPreferences
                (MAIN_CONFIG, Context.MODE_PRIVATE).edit();
        Gson gson = new Gson();
        String json = gson.toJson(new WeatherSave(weatherApp));
