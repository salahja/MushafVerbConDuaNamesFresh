...
public class DataConvertPopup {
    ...
    //    AlertDialog.Builder alertDialog = new AlertDialog.Builder(this, R.style.AboutDialog)
        final Dialog dialog = new Dialog(context,  com.google.android.material.R.style.MaterialAlertDialog_Material3);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.mm_popup_convert);
        ...
        prayershow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!convertTypeFlag) {
                    convertDate();
                    context.startActivity(new Intent(context, PrayShowActivityPrayer.class)
