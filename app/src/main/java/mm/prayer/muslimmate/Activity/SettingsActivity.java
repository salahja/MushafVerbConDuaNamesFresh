        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            ...
            switch (key) {
                case "mmthemepref":
                    ...
                    getActivity().sendBroadcast(new Intent().setAction("Theme "));
                    getActivity().sendBroadcast(new Intent().setAction("Theme change"));
                    startActivity(new Intent(getActivity(), MainTwoActivityPrayer.class)
