 ...
 */
public class CompassActivityPrayer extends PrayerBaseActivity implements SensorEventListener, OnMapReadyCallback, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mm_fragment_compass);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.mm_menu_compass, menu);
        return true;
    }
    ...
    private void init() {
        ...
        if (MainTwoActivityPrayer.locationInfo != null)
        ...
        RotateAnimation ra = new RotateAnimation(currentDegree, MainTwoActivityPrayer.quiblaDegree,
