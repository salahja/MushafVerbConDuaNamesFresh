...
public class PrayShowActivityPrayer extends PrayerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mm_fragment_praying);
     //   getSupportActionBar().setTitle(getString(R.string.praying_time));
    //    getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        //islamic events
        eventList = new ArrayList<>();
        eventList.add(new AppEvent(getString(R.string.ramdanstart), "1-9-1437"));
        eventList.add(new AppEvent(getString(R.string.laylt_kader), "27-9-1437"));
        eventList.add(new AppEvent(getString(R.string.eid_el_feter), "1-10-1437"));
        eventList.add(new AppEvent(getString(R.string.wafet_el_arafa), "9-12-1437"));
        eventList.add(new AppEvent(getString(R.string.el_adha), "10-12-1437"));
        eventList.add(new AppEvent(getString(R.string.islamic_year), "1-1-1438"));
        eventList.add(new AppEvent(getString(R.string.milad_al_naby), "1-3-1438"));
        init();
    }
    ...
    private void init() {
        ...
        try {
          ...
          //  salahNow.setText(CountryPrayerPopup.locationInformation);
            ...
            locationInfo = ConfigPreferences.getLocationConfig(PrayShowActivityPrayer.this);
        ...
        monthView.setText(Dates.gregorianMonthName(PrayShowActivityPrayer.this, hgDate.getMonth() - 1));
        HmonthDay.setText(NumbersLocal.convertNumberType(PrayShowActivityPrayer.this, day + ""));
        HmonthView.setText(Dates.islamicMonthName(PrayShowActivityPrayer.this, month - 1));
        remain.setText(year + "");
        monthDay.setText(NumbersLocal.convertNumberType(PrayShowActivityPrayer.this, hgDate.getDay() + ""));
        ...
        Date[] prayers = new MuslimMatePrayerTimes(dayCal, monthCal +1, yearCal, lr.getLatitude(), lr.getLongitude(), timeZone, !(dst>0), MuslimMatePrayerTimes.getDefaultMazhab(lr.getCountryCode()), MuslimMatePrayerTimes.getDefaultWay(lr.getCountryCode())).get();
