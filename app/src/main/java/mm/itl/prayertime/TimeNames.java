...
public class TimeNames {
    ...
    //    this.res = ResourceBundle.getBundle("resources.org.arabeyes.itl.prayertime.name", locale);
        this.res = ResourceBundle.getBundle("com/example/checkout/org/arabeyes/name", locale);

    //    org/arabeyes/itl/prayertime/name.properties
       // org.arabeyes.itl.prayertime.name
        //org.arabeyes.itl.prayertime.name.properties"
   //     resources/org/arabeyes/itl/prayertime/name.properties
        this.locale = locale;
    }
