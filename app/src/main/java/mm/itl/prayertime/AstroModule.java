...
class AstroModule {
    ...
    static double getSunrise(PrayerModule.Location loc, Astro tastro) {
        return getRiseSet(loc, tastro, Type.SUNRISE);
    }

    static double getSunset(PrayerModule.Location loc, Astro tastro) {
    ...
    private static double getRiseSet(PrayerModule.Location loc, Astro tastro, Type type) {
        /* p. 101 */
    ...
    private static double getRefraction(PrayerModule.Location loc, double sunAlt) {
        double part1, part2;
     ...
     */
    static double getJulianDay(PrayerModule.SDate date, double gmt) {
     ...
     */
    static void getAstroValuesByDay(double julianDay, PrayerModule.Location loc, Astro astro,
                                    Astro topAstro) {
    ...
    private static void computeTopAstro(PrayerModule.Location loc, Astro astro, Astro topAstro) {
        int i;
