...
public class AppPreference {
    ...
    public static SharedPreferences OpenConfigPreferences() {
        try {
            return QuranGrammarApplication.getInstance().getSharedPreferences(AudioAppConstants.Preferences.CONFIG, Context.MODE_PRIVATE);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static void Downloading(boolean flag) {
        ...
        editor.putBoolean(AudioAppConstants.Preferences.DOWNLOAD_STATUS, flag);
        editor.apply();
    }
    ...
    public static void DownloadStatues(int statues) {
        SharedPreferences.Editor editor = OpenConfigPreferences().edit();
        editor.putInt(AudioAppConstants.Preferences.DOWNLOAD_STATUS_TEXT, statues);
        editor.apply();
    }
    ...
    public static void setDownloadType(int type) {
        SharedPreferences.Editor editor = OpenConfigPreferences().edit();
        editor.putInt(AudioAppConstants.Preferences.DOWNLOAD_TYPE, type);
        editor.apply();
    }
    ...
    public static void setDownloadID(int id) {
        SharedPreferences.Editor editor = OpenConfigPreferences().edit();
        editor.putInt(AudioAppConstants.Preferences.DOWNLOAD_ID, id);
        editor.apply();
    }
    ...
    public static void setApplicationLanguage(boolean isArabic) {
        SharedPreferences.Editor editor = OpenConfigPreferences().edit();
        editor.putBoolean(AudioAppConstants.Preferences.LANGUAGE, isArabic);
    }
    ...
    public static void setLastPageRead(int pageNumber) {
        SharedPreferences.Editor editor = OpenConfigPreferences().edit();
        editor.putInt(AudioAppConstants.Preferences.LAST_PAGE_NUMBER, pageNumber);
        editor.apply();
    }
    ...
    public static void setScreenResolution(int resolution) {
        SharedPreferences.Editor editor = OpenConfigPreferences().edit();
        editor.putInt(AudioAppConstants.Preferences.SCREEN_RESOLUTION, resolution);
        editor.apply();
    }
    ...
    public static void setDefaultTafseer(int tafseerID) {
        SharedPreferences.Editor editor = OpenConfigPreferences().edit();
        editor.putInt(AudioAppConstants.Preferences.DEFAULT_EXPLANATION, tafseerID);
        editor.commit();
    }
    ...
    public synchronized static void setSelectionVerse(String info) {
        SharedPreferences.Editor editor = OpenConfigPreferences().edit();
        editor.putString(AudioAppConstants.Preferences.SELECT_VERSE, info);
        editor.commit();
    }
    ...
    public static boolean isDownloading() {
        ...
        boolean isDownloading = preferences.getBoolean(AudioAppConstants.Preferences.DOWNLOAD_STATUS, false);
    ...
    public static int getDownloadStatues() {
        SharedPreferences preferences = OpenConfigPreferences();
        int downloadStatues = preferences.getInt(AudioAppConstants.Preferences.DOWNLOAD_STATUS_TEXT, -1);
    ...
    public static int getLastPageRead() {
        SharedPreferences preferences = OpenConfigPreferences();
        int pageNumber = preferences.getInt(AudioAppConstants.Preferences.LAST_PAGE_NUMBER, -1);
        return pageNumber;
    }
    ...
    public static int getScreenResolution() {
        SharedPreferences preferences = OpenConfigPreferences();
        int resolution = preferences.getInt(AudioAppConstants.Preferences.SCREEN_RESOLUTION, -1);
        return resolution;
    }
    ...
    public static int getDownloadType() {
        SharedPreferences preferences = OpenConfigPreferences();
        int type = preferences.getInt(AudioAppConstants.Preferences.DOWNLOAD_TYPE, -1);
        return type;
    }
    ...
    public static int getDownloadID() {
        SharedPreferences preferences = OpenConfigPreferences();
        int id = preferences.getInt(AudioAppConstants.Preferences.DOWNLOAD_ID, -1);
        return id;
    }
    ...
    public static int getDefaultTafseer() {
        SharedPreferences preferences = OpenConfigPreferences();
        int type = preferences.getInt(AudioAppConstants.Preferences.DEFAULT_EXPLANATION, -1);
        return type;
    }
    ...
    public static void setTranslationTextSize(String size) {
        SharedPreferences.Editor preferences = PreferenceManager.getDefaultSharedPreferences(QuranGrammarApplication.getInstance()).edit();
        preferences.putString(AudioAppConstants.Preferences.TRANSLATION_SIZE, size);
        preferences.commit();
    }
    ...
    public static boolean isVolumeKeyNavigation() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(QuranGrammarApplication.getInstance());
        return preferences.getBoolean(AudioAppConstants.Preferences.VOLUME_NAVIGATION, false);
    }
    ...
    public static boolean isScreeRotationDisabled() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(QuranGrammarApplication.getInstance());
        return preferences.getBoolean(AudioAppConstants.Preferences.ORIENTATION, false);
    }
    ...
    public static boolean isArabicMood(Context context) {
        ...
        return preferences.getBoolean(AudioAppConstants.Preferences.ARABIC_MOOD, false);
    }
    ...
    public static boolean isAyaAppear() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(QuranGrammarApplication.getInstance());
        return preferences.getBoolean(AudioAppConstants.Preferences.AYA_APPEAR, true);
    }
    ...
    public static String getTranslationTextSize() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(QuranGrammarApplication.getInstance());
        return preferences.getString(AudioAppConstants.Preferences.TRANSLATION_SIZE, "large");
    }
    ...
    public static Boolean isStreamMood() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(QuranGrammarApplication.getInstance());
        return preferences.getBoolean(AudioAppConstants.Preferences.STREAM, false);
    }
    /**
    ...
    public static Boolean isNightMood(Context context) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(QuranGrammarApplication.getInstance());
        return preferences.getBoolean(AudioAppConstants.Preferences.NIGHT_MOOD, false);
    }
    ...
    public synchronized static String getSelectionVerse() {
        SharedPreferences preferences = OpenConfigPreferences();
        return preferences.getString(AudioAppConstants.Preferences.SELECT_VERSE, "");
    }
