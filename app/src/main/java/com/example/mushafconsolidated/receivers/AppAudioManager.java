...
public class AppAudioManager extends AsyncTask<String, Long, Boolean> {
     ...
     */
    public AppAudioManager(Context context, List<QuranMetaEntity> ayat, String streamURL, int pageNumber, boolean oneVersePlay) {
     ...
     */
    public AppAudioManager(Context context, List<String> paths, List<QuranMetaEntity> ayat, int pageNumber, boolean oneVersePlay) {
        this.context = context;
        this.paths = paths;
        this.ayat = ayat;
        this.pageNumber = pageNumber;
    ...
    public AppAudioManager(Activity activity) {
    ...
    public synchronized void versePlayAudio() {
       ...
       //     HighlightImageView.selectionFromTouch = false;
          ...
          Intent highlightAya = new Intent(AudioAppConstants.Highlight.INTENT_FILTER);
            ...
            Log.e(AppAudioManager.class.getSimpleName(), "versePlayAudio error : " + e.getLocalizedMessage());
            e.printStackTrace();
    ...
    public synchronized void previousAudio() {
        ...
        //    HighlightImageView.selectionFromTouch = false;
            ...
            e.printStackTrace();
            Log.e(AppAudioManager.class.getSimpleName(), "previousAudio error : " + e.getLocalizedMessage());
            //stop the media service and dismiss the notification
            stopFlag = true;
            stopMedia();
            if (smallMediaPlayer != null) smallMediaPlayer.dismiss();
