...
public class AppAudioManagerExecutor   {
     ...
     */
    public AppAudioManagerExecutor(Context context, List<QuranMetaEntity> ayat, String streamURL, int pageNumber, boolean oneVersePlay) {
     ...
     */
    public AppAudioManagerExecutor(Context context, List<String> paths, List<QuranMetaEntity> ayat, int pageNumber, boolean oneVersePlay, Context activitycontext) {
        this.context = context;
        this.paths = paths;
        this.ayat = ayat;
        this.pageNumber = pageNumber;
    ...
    public AppAudioManagerExecutor() {
    ...
    public void execute() {
        ...
        ex.execute(new Runnable() {
            ...
            public void run() {
                ...
                ( (AppCompatActivity)activitycontext ).runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                ...
                try {
                    ...
                    Log.e(AppAudioManagerExecutor.class.getSimpleName(), "doInBackground error : " + e.getLocalizedMessage());
                    e.printStackTrace();
                    if (bigNotification) {
    ...
    public synchronized void versePlayAudio() {
       ...
       //     HighlightImageView.selectionFromTouch = false;
          ...
          Intent highlightAya = new Intent(AudioAppConstants.Highlight.INTENT_FILTER);
            ...
            Log.e(AppAudioManagerExecutor.class.getSimpleName(), "versePlayAudio error : " + e.getLocalizedMessage());
            e.printStackTrace();
    ...
    public synchronized void nextAudio() {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e(AppAudioManagerExecutor.class.getSimpleName(), "nextAudio error : " + e.getLocalizedMessage());
            //stop the media service and dismiss the notification
            stopFlag = true;
            stopMedia();
            if (smallMediaPlayer != null) smallMediaPlayer.dismiss();
    ...
    public synchronized void previousAudio() {
        ...
        //    HighlightImageView.selectionFromTouch = false;
            ...
            e.printStackTrace();
            Log.e(AppAudioManagerExecutor.class.getSimpleName(), "previousAudio error : " + e.getLocalizedMessage());
            //stop the media service and dismiss the notification
            stopFlag = true;
            stopMedia();
            if (smallMediaPlayer != null) smallMediaPlayer.dismiss();
