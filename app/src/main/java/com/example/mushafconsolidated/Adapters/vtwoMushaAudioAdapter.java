...
public class vtwoMushaAudioAdapter extends RecyclerView.Adapter<vtwoMushaAudioAdapter.ItemViewAdapter>
        //implements OnItemClickListenerOnLong {
{
    ...
    public vtwoMushaAudioAdapter(Context context, List<QuranEntity> quranbySurah, OnItemClickListenerOnLong listener, long surah_id, String surahName, int ismakki, ArrayList<String> header) {
...
//bg_black
    ...
    public void displayAyats(boolean showrootkey, vtwoMushaAudioAdapter.ItemViewAdapter holder, int position, SharedPreferences sharedPreferences, Typeface custom_font, boolean showErab, boolean showWordColor, boolean showTransliteration, boolean showJalalayn, boolean showTranslation, boolean showWordByword, String whichtranslation, boolean showKathir) {
        ...
        for (QuranEntity quran : allofQuran) {
            ...
            boolean isFirst = true;
              ...
              bb.append(aya).append("﴿ { ").append(quran.getAyah()).append("} ﴾");
                ...
                //    builder.append(aya); // +1 as substring upper bound is excluded
                  //  builder.append("\n");
                    // cute ayah
