        ...
        //implements OnItemClickListenerOnLong {
{
    ...
    public LineMushaAudioAdapter(Context context, List<QuranEntity> quranbySurah, OnItemClickListenerOnLong listener, String surahName, int ismakki, ArrayList<String> header) {
