...
public class ShowMushafActivitybeforeammendmenttwo extends BaseActivity implements
...
// LinearLayout fabLayout1, fabLayout2,fabLayout3;
    ...
    public void onBackPressed() {
        ...
        LocalBroadcastManager.getInstance(ShowMushafActivitybeforeammendmenttwo.this).unregisterReceiver(downloadPageAya);
    ...
    private void initSpinner() {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                ArrayAdapter<String> spinnerReaderAdapter = new ArrayAdapter<>(ShowMushafActivitybeforeammendmenttwo
    ...
    public void SurahAyahPicker(boolean isrefresh, boolean starttrue) {
        ...
        Utils utils = new Utils(ShowMushafActivitybeforeammendmenttwo.this);
        ...
        AlertDialog.Builder dialogPicker = new AlertDialog.Builder(ShowMushafActivitybeforeammendmenttwo.this);
        Dialog dlg = new Dialog(ShowMushafActivitybeforeammendmenttwo.this);
        //  AlertDialog dialog = builder.create();
        ArrayList<ChaptersAnaEntity> soraList = utils.getAllAnaChapters();
        LayoutInflater inflater = ShowMushafActivitybeforeammendmenttwo.this.getLayoutInflater();
...
//        wvDay = (WheelView) view.findViewById(R.id.wv_day);
        ...
        buttonPositive.setTextColor(ContextCompat.getColor(ShowMushafActivitybeforeammendmenttwo.this, R.color.green));
        Button buttonNegative = alertDialog.getButton(DialogInterface.BUTTON_NEGATIVE);
        buttonNegative.setTextColor(ContextCompat.getColor(ShowMushafActivitybeforeammendmenttwo.this, R.color.red));
        if (preferences.equals("light")) {
            buttonPositive.setTextColor(ContextCompat.getColor(ShowMushafActivitybeforeammendmenttwo.this, R.color.colorMuslimMate));
            buttonNegative.setTextColor(ContextCompat.getColor(ShowMushafActivitybeforeammendmenttwo.this, R.color.red));
            ...
            buttonPositive.setTextColor(ContextCompat.getColor(ShowMushafActivitybeforeammendmenttwo.this, R.color.yellow));
            buttonNegative.setTextColor(ContextCompat.getColor(ShowMushafActivitybeforeammendmenttwo.this, R.color.Goldenrod));
            //  cardview.setCardBackgroundColor(db);
        } else if (preferences.equals("green")) {
            buttonPositive.setTextColor(ContextCompat.getColor(ShowMushafActivitybeforeammendmenttwo.this, R.color.yellow));
            buttonNegative.setTextColor(ContextCompat.getColor(ShowMushafActivitybeforeammendmenttwo.this, R.color.cyan_light));
            //  cardview.setCardBackgroundColor(MUSLIMMATE);
        }
...
///musincadapter
            ...
            if (null != holder) {
                try {
                    ...
                    Toast.makeText(ShowMushafActivitybeforeammendmenttwo.this, "null pointer udapte", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            if (currenttrack > 1) {
                if (null != holderp) {
                    try {
                        ...
                        FlowLayout fl = new FlowLayout(ShowMushafActivitybeforeammendmenttwo.this, arrayList);
                        ...
                        Toast.makeText(ShowMushafActivitybeforeammendmenttwo.this, "UPDATE HIGHLIGHTED", Toast.LENGTH_SHORT).show();
                    }
    ...
    protected boolean initializePlayer() {
        ...
        if (player == null) {
            ...
            if (stream) {
                ...
                player =
                        new ExoPlayer.Builder(ShowMushafActivitybeforeammendmenttwo.this)
                                .setMediaSourceFactory(
                                        new DefaultMediaSourceFactory(ShowMushafActivitybeforeammendmenttwo.this).setLiveTargetOffsetMs(5000))
                                .build();
...
// Per MediaItem settings.
                ...
                player.addListener(new ShowMushafActivitybeforeammendmenttwo.PlayerEventListener());
    ...
    private void initRV() {
        ...
        canceldownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stopService(new Intent(ShowMushafActivitybeforeammendmenttwo.this, DownloadService.class));
...
//https://cdn.islamic.network/quran/audio-surah/128/ar.alafasy/
    ...
    private void DownLoadIfNot(int internetStatus, ArrayList<String> Links) {
        if (internetStatus <= 0) {
            ...
            Intent intent = new Intent(ShowMushafActivitybeforeammendmenttwo.this, DownloadService.class);
