package com.example.mushafconsolidated.placeholder;
...
public class PlaceholderContent {
    ...
    private static void addItem(PlaceholderItem item) {
        ITEMS.add(item);
        ITEM_MAP.put(item.contentid, item);
    }
    ...
    private static PlaceholderItem createPlaceholderItem(int position) {
       ...
       // return new PlaceholderItem(String.valueOf(position), "Item " + position, makeDetails(position));
        return new PlaceholderItem(String.valueOf(position), array[position], makeDetails(position,array[position]));
    }

    private static String makeDetails(int position, String s) {
