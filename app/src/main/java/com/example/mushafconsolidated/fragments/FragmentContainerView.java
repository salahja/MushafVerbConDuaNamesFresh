 ...
 * </pre>
 */
public class FragmentContainerView extends BottomSheetDialogFragment  {
    ...
    public static FragmentContainerView newInstance() {
        final FragmentContainerView fragment = new FragmentContainerView();
;
        return fragment;
